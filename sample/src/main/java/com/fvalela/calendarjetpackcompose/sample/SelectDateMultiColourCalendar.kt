...
class SelectDateMultiColourCalendar : AppCompatActivity() {
            ...
            CalendarJetpackComposeSampleTheme(darkTheme = false) {
                Surface(
                    ...
                    Column(Modifier.fillMaxSize()) {
                        SelectDateMultiColourCalendarHelper(viewModel = viewModel)
                        DatesList(viewModel)
                    }
                }
            }
...
@Composable
private fun SelectDateMultiColourCalendarHelper(viewModel: CalendarViewModel) {
